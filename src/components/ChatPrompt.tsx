...
const ChatPrompt: FC<ChatPromptProp> = (props) => {
  ...
  const from = props.session?.messageList[props.session?.messageList.length - 1]
      ...
      <div className="chat__prompt is-open" data-target="prompt">
        <div className="chat__prompt-main">
          <div className="chat__prompt-message">
            <div className="chat__prompt-message-profile">&nbsp;</div>
            <div className="chat__prompt-message-copy">
              <h3>
                {" "}
                {getOperatorName(
                  lastMessage?.user_id,
                  parentContext.agents
                )}{" "}
              </h3>
            </div>
          </div>
        ...
        <div className="chat__prompt-parent">
          <PromptFooter
            ...
            handleProactiveMessageSubmit={props.handleProactiveMessageSubmit}
          />
        </div>
      </div>
    </>
